...
> = ({ lotteryNodeData, lotteryId }) => {
  ...
  if (lotteryNodeData) {
    const { amountCollectedInGDE } = lotteryNodeData
    prizeInBusd = amountCollectedInGDE.times(gdePriceBusd)
  }
      ...
      <>
        ...
        {prizeInBusd.isNaN() ? (
          ...
          <Balance
            ...
            color="textSubtle"
            unit=" GDE"
            value={getBalanceNumber(lotteryNodeData?.amountCollectedInGDE)}
            decimals={0}
          />
        )}
      </>
