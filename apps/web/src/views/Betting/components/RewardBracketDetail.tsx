    ...
    <Flex flexDirection="column">
      ...
      <>
        {isLoading || cakeAmount.isNaN() ? (
          ...
          <Balance fontSize="20px" bold unit=" GDE" value={getBalanceNumber(cakeAmount)} decimals={0} />
        )}
        {isLoading || cakeAmount.isNaN() ? (
          <>
          ...
          <Balance
            ...
            color="textSubtle"
            prefix="~$"
            value={getBalanceNumber(cakeAmount.times(gdePriceBusd))}
            decimals={0}
          />
        )}
          ...
          <>
            {numberWinners !== '0' && (
              <Text fontSize="12px" color="textSubtle">
                {getFullDisplayBalance(cakeAmount.div(parseInt(numberWinners, 10)), 18, 2)} GDE {t('each')}
              </Text>
            )}
            <Text fontSize="12px" color="textSubtle">
