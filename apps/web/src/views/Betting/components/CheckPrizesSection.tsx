...
import { FetchStatus, PerformanceStatus } from 'config/constants/types'
...
const CheckPrizesSection = () => {
  ...
  const lotteryIsNotClaimable = status === PerformanceStatus.CLOSE
  const isCheckNowDisabled = !userPerformanceData.account || lotteryIsNotClaimable
